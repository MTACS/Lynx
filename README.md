...
Requires libcolorpicker (1.6.7) from [BigBoss](http://cydia.saurik.com/package/org.thebigboss.libcolorpicker/) Cephei (1.14) from [Chariz](https://repo.chariz.io/package/ws.hbang.common/) AppList from [Ryan Petrich's Repo](http://rpetri.ch/repo)
